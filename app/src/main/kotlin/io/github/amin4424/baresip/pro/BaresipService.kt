...
import io.github.amin4424.baresip.pro.Utils.e164Uri
import io.github.amin4424.baresip.pro.Utils.toCircle
...
class BaresipService: Service() {
    ...
    override fun onCreate() {
        ...
        intent = Intent("io.github.amin4424.baresip.pro.EVENT")
        intent.setPackage("io.github.amin4424.baresip.pro")
        ...
        partialWakeLock = pm.newWakeLock(
            ...
            "io.github.amin4424.baresip.pro:wakelock"
        ...
        proximityWakeLock = pm.newWakeLock(
            ...
            "io.github.amin4424.baresip.pro:proximity_wakelock"
        )
    ...
    override fun onDestroy() {
        ...
        cleanService()
        instance = null
        if (isServiceRunning) sendBroadcast(Intent("io.github.amin4424.baresip.pro.Restart"))
    }
