...
import io.github.amin4424.baresip.promax.Utils.e164Uri
import io.github.amin4424.baresip.promax.Utils.toCircle
...
class BaresipService: Service() {
    ...
    override fun onCreate() {
        ...
        intent = Intent("io.github.amin4424.baresip.promax.EVENT")
        intent.setPackage("io.github.amin4424.baresip.promax")
        ...
        partialWakeLock = pm.newWakeLock(
            ...
            "io.github.amin4424.baresip.promax:wakelock"
        ...
        proximityWakeLock = pm.newWakeLock(
            ...
            "io.github.amin4424.baresip.promax:proximity_wakelock"
        )
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        when (action) {
            ...
            "Start Call" -> {
                ...
                runCall(uap, uri, conferenceCall, videoCall, onHoldCallp)
            }
    ...
    override fun onDestroy() {
        ...
        instance = null
        if (isServiceRunning)
            sendBroadcast(Intent("io.github.amin4424.baresip.promax.Restart"))
    }
    ...
    fun runCall(uap: Long, uriText: String, conferenceCall: Boolean, videoCall: Boolean, onHoldCallp: Long) {
    ...
    fun handleIncomingCall(call: Call) {
        ...
        if (!Utils.isVisible()) {
            ...
            val contentText = if (diverterUri != "")
                "${getString(R.string.is_calling)} (${getString(R.string.diverted_by)} ${Utils.friendlyUri(this, diverterUri, ua.account)})"
            else
    ...
    fun toggleSpeakerphone() {
        ...
        postServiceEvent(
            ServiceEvent("speaker update,$speakerPhone", arrayListOf(0L, 0L), System.nanoTime())
        )
    ...
    companion object {
        ...
        const val SIP_ACCOUNT_ID = "baresip_plus_sip_account"
        const val PSTN_ACCOUNT_ID = "baresip_plus_phone_account"
        ...
        private fun isBluetoothScoOn(am: AudioManager): Boolean {
            return if (VERSION.SDK_INT < 31)
                @Suppress("DEPRECATION")
                am.isBluetoothScoOn
            else if (am.communicationDevice != null)
